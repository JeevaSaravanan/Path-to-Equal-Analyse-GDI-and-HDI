...
tab1, tab2, tab3 = st.tabs(["Project Origins: Unveiling the Background and Purpose", "The Dataset","The Project's Significance: Why Pursuing It is Worthwhile"])

with tab1:
    st.subheader('Project Origins: Unveiling the Background and Purpose')
    st.markdown("""
    ***Goal:***
    The goal of this project is to analyze the Gender Development Index (GDI) dataset to understand the extent of gender disparities in human development across different countries. we can analyse how do gender disparities in health and education impact overall human development and improvement over these years
    """)
...
with tab3:
    st.subheader("")
    st.markdown("""
    - This project is worthy of completion because it addresses a critical issue – gender disparities in human development – which has real-world implications for policymaking and social progress. By analyzing the GDI dataset and creating an accessible web app, we can contribute to the ongoing efforts to promote gender equality and improve human development outcomes globally.
